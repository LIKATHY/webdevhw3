defmodule Microblog.BlogTest do
  ...
  describe "posts" do
    ...
    @valid_attrs %{author: "some author", body: "some body", postId: 42, title: "some title"}
    @update_attrs %{author: "some updated author", body: "some updated body", postId: 43, title: "some updated title"}
    @invalid_attrs %{author: nil, body: nil, postId: nil, title: nil}
